    ...
    <main class="admin-login-shell">
        ...
        <section class="admin-login-card">
            <div class="admin-login-brand">
                <span class="admin-chip">Private Boss Dashboard</span>
                <h1>Jenang Gemi Control Room</h1>
                <p>Access to traffic, source attribution, conversion flow, and session-depth analytics for all Bubur campaign landing pages.</p>
            </div>
            <form method="post" class="admin-login-form" autocomplete="off">
                <label for="admin_code">Admin Code</label>
                <input id="admin_code" name="admin_code" type="password" inputmode="numeric" pattern="[0-9]*" placeholder="Enter 6-digit code" required autofocus>
                <?php if ($hasError): ?>
                    <p class="admin-login-error">Admin code tidak valid.</p>
                <?php endif; ?>
                <button type="submit" class="admin-primary-btn">Unlock Dashboard</button>
            </form>
        </section>
    </main>
<?php else: ?>
    <div class="admin-app" data-admin-dashboard data-analytics-endpoint="./analytics.php">
        <div class="admin-backdrop admin-backdrop-a"></div>
        <div class="admin-backdrop admin-backdrop-b"></div>
        <header class="admin-topbar">
            <div class="admin-topbar-brand">
                <span class="admin-chip">Authenticated Session</span>
                <h1>Jenang Gemi Signal Deck</h1>
            ...
            <div class="admin-topbar-actions">
                ...
                <a class="admin-primary-btn admin-link-btn" href="./logout.php">Lock Dashboard</a>
            </div>
        </header>
        ...
        <main class="admin-layout">
            <section class="admin-hero-panel">
                <div class="admin-hero-copy">
                    ...
                    <h2>High-contrast dashboard for YouTube, Facebook, Instagram, and TikTok performance.</h2>
                    <p>Views, Order Now clicks, checkout intent, average time spent, and the latest tracked sessions are all available below without exposing the raw analytics endpoint publicly.</p>
                </div>
            ...
            <section class="admin-main-grid">
                ...
                <article class="admin-panel admin-panel-feed">
                    ...
                    <div class="admin-note-stack">
                        ...
                        <div class="admin-note-card"><strong>Endpoint</strong><span data-endpoint-label>./analytics.php</span></div>
                    </div>
                </article>
            </section>
        </main>
